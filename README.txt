=== Plugin Name ===
Contributors: Dinesh Ghimire
Donate link: http://dinesh-ghimire.com.np/
Tags: Accordian, Shortcode
...
This is accordian shortcode plugin. You can enter all argument of WP_Query to this shortcodes.
...
2. Upload "dg-accordian" to your wp-
content/plugins/directory
3. Activate the plugin through the 'Plugins' menu in WordPress
4. Put shortcode to anywhere [dg_accordian post_type="post" posts_per_page="3"][/dg_accordian]
...
= Can we make accordian of post type? =

You can make accordian of post type, category, tags or taxonomy also.
